            ...
            <View style={styles.legendContainer}>
              {selectedPeriod === 'Day' && (
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <View style={[styles.checkbox, respirationOverlayChecked && styles.checkboxChecked, isLightTheme && { borderColor: 'rgba(0,0,0,0.2)' }, isLightTheme && respirationOverlayChecked && { backgroundColor: '#8E24AA', borderColor: '#8E24AA' }]}>
