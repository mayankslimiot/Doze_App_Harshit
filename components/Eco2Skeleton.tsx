    ...
    >
      ...
      >
        <LinearGradient
          colors={[
            'transparent',
            isLightTheme ? 'rgba(0, 0, 0, 0.04)' : 'rgba(255, 255, 255, 0.1)',
            'transparent',
          ]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 0 }}
...
export default function ECO2Skeleton() {
  const { isLightTheme } = useTheme();
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.healthyRangeContainer, isLightTheme && { backgroundColor: '#FFFFFF', borderColor: 'rgba(0,0,0,0.06)', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 3, elevation: 1 }]}>
