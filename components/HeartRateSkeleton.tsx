...
function SkeletonBox({ width, height, borderRadius = 8, style }: SkeletonBoxProps) {
  ...
  // Calculate numeric width for animation (use screen width as fallback for percentage widths)
...
export default function HeartRateSkeleton() {
  return (
    <View style={styles.container}>
      ...
      {/* Healthy Range Container Skeleton */}
      ...
      <View style={styles.chartContainer}>
        ...
        <View style={styles.chartWrapper}>
          ...
          {/* Chart area with graph line simulation */}
...
const styles = StyleSheet.create({
  container: {
    // No padding - parent ScrollView handles it
  },
  metricsRow: {
    flexDirection: 'row',
