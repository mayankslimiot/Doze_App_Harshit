/**
 * IAQ aggregation utilities
 * Aggregates raw iaq points based on zoom level
 */
...
interface AggregatedPoint {
  ...
  y: number | null; // Aggregated iaq value, null indicates gap
}

/**
 * Aggregate raw iaq points based on zoom level
 * Groups points into buckets based on intervalSec and computes average
 * 
 * @param rawPoints - Array of raw iaq points
