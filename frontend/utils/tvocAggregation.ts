/**
 * TVOC aggregation utilities
 * Aggregates raw tvoc points based on zoom level
 */
...
interface AggregatedPoint {
  ...
  y: number | null; // Aggregated tvoc value, null indicates gap
}

/**
 * Aggregate raw tvoc points based on zoom level
 * Groups points into buckets based on intervalSec and computes average
 * 
 * @param rawPoints - Array of raw tvoc points
