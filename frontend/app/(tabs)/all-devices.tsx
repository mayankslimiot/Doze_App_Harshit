...
export default function AllDevicesScreen() {
  ...
  const { setSelectedDevice, setProvisionForHospitalId, setProvisionForHospitalName } = useProvisioning();
  ...
  useFocusEffect(
    React.useCallback(() => {
      console.log('[AllDevices] Screen focused — triggering refreshDevices');
      refreshDevices().catch((err) => console.warn('[AllDevices] Auto-refresh devices failed:', err));
    }, [])
  );
          ...
          <View>
            ...
            {activeDevice && (
              <View style={styles.section}>
                ...
                <View style={[styles.activeDeviceCard, { backgroundColor: 'transparent' }]}>
