  ...
  return (
    <SafeAreaView style={[styles.container, isLightTheme && { backgroundColor: '#F8F9FA' }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerText, isLightTheme && { color: '#111111' }]}>Terms of Service</Text>
      ...
      >
        ...
        >
          <Text style={[styles.legalText, isLightTheme && { color: '#333333' }]}>{TERMS_AND_CONDITIONS}</Text>
        </ScrollView>
      </ContentContainer>
    </SafeAreaView>
  );
