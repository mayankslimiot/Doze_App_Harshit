/**
 * Temperature aggregation utilities
 * Aggregates raw temperature points based on zoom level
 */
...
interface AggregatedPoint {
  ...
  y: number | null; // Aggregated temperature value, null indicates gap
}

/**
 * Aggregate raw temperature points based on zoom level
 * Groups points into buckets based on intervalSec and computes average
 * 
 * @param rawPoints - Array of raw temperature points
