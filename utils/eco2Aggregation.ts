/**
 * ECO2 aggregation utilities
 * Aggregates raw eco2 points based on zoom level
 */
...
interface AggregatedPoint {
  ...
  y: number | null; // Aggregated eco2 value, null indicates gap
}

/**
 * Aggregate raw eco2 points based on zoom level
 * Groups points into buckets based on intervalSec and computes average
 * 
 * @param rawPoints - Array of raw eco2 points
