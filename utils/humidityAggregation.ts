/**
 * Humidity aggregation utilities
 * Aggregates raw humidity points based on zoom level
 */
...
interface AggregatedPoint {
  ...
  y: number | null; // Aggregated humidity value, null indicates gap
}

/**
 * Aggregate raw humidity points based on zoom level
 * Groups points into buckets based on intervalSec and computes average
 * 
 * @param rawPoints - Array of raw humidity points
 ...
 */
export function aggregateHumidity(
  rawPoints: RawPoint[],
  zoomIndex: number,
