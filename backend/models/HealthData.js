...
const HealthDataSchema = new mongoose.Schema({
    ...
    voc: { type: Number },
    vocRaw: { type: Number },
    vocStatus: { type: Number },
    vocAlert: { type: Number },
    eventText: { type: String },
    heartRateValid: { type: Number },
    ventilationNeeded: { type: Number },
    
    metrics: {
        respirationMedian: { type: Number },
        heartRateSD: { type: Number },
        respirationSD: { type: Number },
        nn50: { type: Number },
        sdsd: { type: Number },
        mxdmn: { type: Number },
        mo: { type: Number },
